...
var CornerstoneViewport = /*#__PURE__*/function (_Component) {
  ...
  _createClass$x(CornerstoneViewport, [{
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                try {
                  ...
                  cornerstoneTools.addStackStateManager(this.element, ['stack', 'playClip', 'referenceLines', 'Crosshairs']);
    ...
    value: function _bindInternalCornerstoneEventListeners() {
      ...
      cornerstone.events[addOrRemoveEventListener]('cornerstoneimageloadprogress', this.onImageProgress);
    ...
    value: function _bindInternalElementEventListeners() {
      ...
      this.element[addOrRemoveEventListener](cornerstone.EVENTS.NEW_IMAGE, this.onNewImage);

      // Updates state's imageId, and imageIndex
      this.element[addOrRemoveEventListener](cornerstone.EVENTS.NEW_IMAGE, this.onNewImageDebounced);

      // Updates state's viewport
      this.element[addOrRemoveEventListener](cornerstone.EVENTS.IMAGE_RENDERED, this.onImageRendered);
